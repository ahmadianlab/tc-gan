...
def make_MOMENT_functions(rate_vector,sample_sites,NZ,NB,NCOND,LOSS,g_lr,rate_cost,rate_penalty_threshold,rate_penalty_no_I,ivec,Z,J,D,S,N,R_grad,track_offset_identity,lam):
...
def main(args=None):
    ...
    parser.set_defaults(
        datastore_template='logfiles/conditional_moments_{IO_type}_{rate_cost}',
    )
