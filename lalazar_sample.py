...
RF_low = theano.shared(np.float32(.0048),name = "RF_s")
RF_del = theano.shared(np.float32(1.03),name = "mean_W")
THR = theano.shared(np.float32(1.25),name = "s_W")
THR_del = theano.shared(np.float32(np.log(31.38)),name = "s_W")
Js = theano.shared(np.float32(np.log(5011.52)),name = "mean_b")
As = theano.shared(np.float32(np.log(1)),name = "dist")
